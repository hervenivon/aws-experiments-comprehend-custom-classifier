...
- AWS Comprehend [recommends](https://docs.aws.amazon.com/comprehend/latest/dg/how-document-classification-training.html) _“that you train the model with up to 1,000 training documents for each label.”_ This is enforced when you use the console _“Must be at least 1K documents per label.”_
- When you select your label, AWS Comprehend _“suggest[s] labels that are clear and don't overlap in meaning.”_
...
Roughly 140000 lines per label. Amazon Comprehend “recommend[s] that you train the model with up to 1,000 training documents for each label.” and no more than 1000000 documents.
